-- Reaplicação do Knowledge Pack — a migration 20260527000002 rodou ANTES do
-- usuário admin existir, então o bloco DO $$ não inseriu nada.
-- Agora que nucleodameta@gmail.com está criado, esta migration completa o preenchimento.
